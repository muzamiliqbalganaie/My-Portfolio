...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        { href: "https://www.linkedin.com/in/sarfaroshnew/", icon: "/assets/linkedin.svg", title: "LinkedIn", className: "transition-transform hover:scale-110 hover:bg-blue-700 p-2 rounded-full" },
